...
namespace ShipItSharp.Console.Commands.SubCommands
{
        ...
        : BaseCommand(octopusHelper, languageProvider)
    {
        ...
        public override void Configure(CommandLineApplication command)
        {
            ...
            command.Description = LanguageProvider.GetString(LanguageSection.OptionsStrings, "TaskCancel");
        ...
        private int WriteResult(string environment, TaskOperationResult result)
        {
            if (!result.Found)
            {
            ...
            System.Console.WriteLine(LanguageProvider.GetString(LanguageSection.UiStrings, "CancelledQueuedTasks"), result.AffectedTaskIds.Count, environment);
